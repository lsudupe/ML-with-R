...
#create our test/train labels
sample <- sample.split(amino,SplitRatio = 0.67)

train_label <- subset(amino$V18, sample == TRUE)
test_label <- subset(amino$v18, sample == FALSE)

#create training and test data
sample2 <- sample.split(amino_one_hot,SplitRatio = 0.67)

train_data <- subset(amino_one_hot, sample2 == TRUE)
test_data <- subset(amino_one_hot, sample2 == FALSE)
